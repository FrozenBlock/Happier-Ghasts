...
package net.frozenblock.springierlife;
...
public final class SLConstants {
	public static final String PROJECT_ID = SLPreLoadConstants.PROJECT_ID;
	public static final String MOD_ID = SLPreLoadConstants.MOD_ID;
	public static final Logger LOGGER = SLPreLoadConstants.LOGGER;
	/**
