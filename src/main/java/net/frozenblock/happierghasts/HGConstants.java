...
public final class HGConstants {
	public static final String PROJECT_ID = HGPreLoadConstants.PROJECT_ID;
	public static final String MOD_ID = HGPreLoadConstants.MOD_ID;
	public static final Logger LOGGER = HGPreLoadConstants.LOGGER;
	/**
